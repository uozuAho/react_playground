...
interface ComponentSlotSettingsState {
  mode: 'view' | 'edit';
  settings: Settings;
}

export class ComponentSlotSettings extends React.Component<{}, ComponentSlotSettingsState> {
